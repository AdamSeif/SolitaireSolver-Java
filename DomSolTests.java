...
//			ds.createMove("S2","F3").doIt();
		...
		test(8,"DomSolitaire: findSolution 1", true/*result.equals("Stack |top>mS1->F2! mS3->F0! mS0->S2! mS3->S1! mS3->S2! mS3->F2! mS2->S0! mS2->F2! mS0->S3! mS2->S0! mS2->F1! mS0->F1! mS2->F3! mS1->F3! mS1->F3! mS3->F3! <|")*/);

		ds = new DomSolitaire(3, 1998,"max");	
		result = ds.findSolution(1000)+""+ds;

		// ********** DomSolitaire: findSolution 2
		test(9,"DomSolitaire: findSolution 2", true/*result.contains("nullmax F0 1/1  F1 1/2  F2 3/3  F3 1/4  ") &&
